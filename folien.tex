...
\author[Ingo Blechschmidt]{Ingo Blechschmidt \\[0.5em] Augsburger Linux-Infotag \\ 24. März 2012}
...
\section{Live-Vorführungen}
\frame[t]{\frametitle{Live-Vorführungen}
  \begin{enumerate}
    \item Erste Schritte: Ping \\
          Demonstration von ARP, DNS und ICMP
    \item Webseitenaufruf
